...
if(!empty($_POST)) {
	...
	$pdo->exec("REPLACE INTO produit (id_produit, reference, categorie, titre, description, couleur, taille, public, photo, prix, stock) VALUES ('$id_produit', '$_POST[reference]', '$_POST[categorie]', '$_POST[titre]', '$_POST[description]', '$_POST[couleur]', '$_POST[taille]', '$_POST[sexe]', '$photo_bdd', '$_POST[prix]', '$_POST[stock]')");
...
while($produits = $resultat->fetch(PDO::FETCH_ASSOC)) { // boucle sur les données
      ...
      $content .='<td><a href="?page=gestion-des-produits&action=modification&id_produit=' . $produits['id_produit'] . '"><span class="glyphicon glyphicon-pencil"></span></a></a></td>'; // lien modification
      $content .= '<td><a href="?page=gestion-des-produits&action=suppression&id_produit=' . $produits ['id_produit'] . '" onClick="return(confirm(\'En êtes vous certain?\'))"><span class="glyphicon glyphicon-trash"></span></a></td>'; // lien suppression
}
...
<div class="form-group">
  ...
  <input type="text" id="reference" name="reference" placeholder="Réference du produit" value="' . $reference . '"><br>
</div>
<div class="form-group">
...
<div class="form-group">
  ...
  <textarea name="description" placeholder="Description du produit">' . $description . '</textarea><br>
</div>
<div class="form-group">
...
<div class="form-group">
  ...
  <input type="file" name="photo" placeholder="Photo du produit">';
    if(!empty($photo))
    {
...
<div class="form-group">
  ...
  <input type="text" name="prix" placeholder="Prix du produit" value="' . $prix . '"><br>
</div>
<div class="form-group">
  <label for="stock">Stock : </label><br>
  <input type="text" name="stock" placeholder="Stock du produit" value="' . $stock . '"><br>
</div>
<div class="form-group">
